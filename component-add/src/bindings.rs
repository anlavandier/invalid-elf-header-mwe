...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_add_two_cabi<T: Guest>(arg0: i32, arg1: i32) -> i32 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let result0 = T::add_two(arg0 as u32, arg1 as u32);
    _rt::as_i32(result0)
}
pub trait Guest {
...
macro_rules! __export_world_example_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        } } #[unsafe (export_name = "add-two")] unsafe extern "C" fn export_add_two(arg0
        : i32, arg1 : i32,) -> i32 { unsafe { $($path_to_types)*::
        _export_add_two_cabi::<$ty > (arg0, arg1) } } };
    };
}
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x01@\x02\x01xy\x01yy\0y\x04\0\x07add-two\x01\x01\
\x04\0\x15component:add/example\x04\0\x0b\x0d\x01\0\x07example\x03\0\0\0G\x09pro\
